...
{
    public class Bulb1 : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Bulb1");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num3;
                for (int num492 = 0; num492 < 4; num492 = num3 + 1)
                {
                    ...
                    Projectile.NewProjectile(projectile.position.X + num493, projectile.position.Y + num494, num493, num494, mod.ProjectileType("Bulb2"), (int)((double)projectile.damage * 0.5), 0f, projectile.owner, 0f, 0f);
                    num3 = num492;
                }
            }
            Main.PlaySound(SoundID.Item19, projectile.position);
        }
